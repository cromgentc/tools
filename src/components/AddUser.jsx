...
export default function AddUser() {
  ...
  return (
    <div className="max-w-2xl mx-auto rounded-xl border border-gray-700 bg-gradient-to-br from-gray-800 to-gray-900 p-8 text-white shadow-xl">
      <div className="mb-8">
      ...
      {(bulkResult.inserted.length > 0 || bulkResult.errors.length > 0) && (
        <div className="mt-8 rounded-lg border border-gray-600 bg-gradient-to-br from-gray-700 to-gray-800 p-6">
